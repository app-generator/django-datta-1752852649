...
- Get [Support](https://app-generator.dev/ticket/create/?generated_repo=https://github.com/app-generator/django-datta-1752852649) via `eMail` and `Discord`
- Resources:
...
```bash
$ git clone https://github.com/django-datta-1752852649.git
$ cd django-datta-1752852649
```
